...
module Sync
  class DiscrepancyService
    def initialize(external_server)
      @external_server = external_server
    end

    # TODO: Add index on external_reference column
    def execute
      ...
      local_data = Sync::Campaign.where(external_reference: external_references).all
    ...
    def keys(external_records)
      external_records.first.keys - ['reference']
    end
